-- Generated from content/posts/chatgpt-safe-launcher-public-beta.md
INSERT INTO posts (slug, title, description, content, date, tags, cover, series, series_order, featured, draft)
VALUES ('chatgpt-safe-launcher-public-beta', 'ChatGPT Safe Launcher 首个公开测试版发布', '一个面向 Windows ChatGPT/Codex Desktop 三个 bundled 插件的检测、恢复与安全启动工具，现已开放源码和测试安装包。', '## 为什么做这个工具
...
后续会继续关注不同 Windows 11 环境、不同 Desktop 更新版本、备份恢复、主题与界面、安装器兼容性，以及三插件真实交互验证的稳定性。', '2026-08-09', '["Windows","ChatGPT","Codex","开源工具","插件修复"]', NULL, 'Windows 工具开发', 1, 1, 0)
