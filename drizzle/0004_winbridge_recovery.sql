-- Generated from content/posts/winbridge-recovery-public-beta.md
DELETE FROM posts WHERE slug = 'chatgpt-safe-launcher-public-beta';
INSERT INTO posts (slug, title, description, content, date, tags, cover, series, series_order, featured, draft)
VALUES ('winbridge-recovery-public-beta', 'WinBridge Recovery 首个公开测试版发布', '一个独立的 Windows GPT/Codex Desktop 插件修复与安全启动工具，支持 Browser、Chrome 和 Computer Use 状态恢复。', '## 为什么重新命名
...
本项目目前免费、非商业，主要用于学习、测试和帮助遇到同类 Windows 插件状态问题的用户。', '2026-08-10', '["Windows","GPT 插件修复","Codex","开源工具","插件恢复"]', NULL, 'Windows 工具开发', 1, 1, 0)
