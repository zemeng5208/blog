-- Generated from content/posts/winbridge-4-alpha-architecture.md
INSERT INTO posts (slug, title, description, content, date, tags, cover, series, series_order, featured, draft)
VALUES ('winbridge-4-alpha-architecture', 'WinBridge Recovery 4.0 Alpha 1：从“修复脚本外壳”走向隔离运行时与诊断优先', '4.0 Alpha 1 已发布源码开发预览：新的 Electron/Worker 架构、诊断优先流程、独立插件状态面板与 74 项自动化测试。', 'WinBridge Recovery `4.0.0 Alpha 1` 已经作为 **Development Preview** 发布。
...
我会继续把 4.0 的进展拆成文章记录，而不是等“全部做完”以后才回头写一份无法还原决策过程的总结。', '2026-08-14', '["WinBridge Recovery","Electron","Worker","Codex","软件架构","Alpha"]', NULL, 'Windows 工具开发', 3, 1, 0)
